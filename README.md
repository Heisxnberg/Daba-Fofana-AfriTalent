...
AfriTalent
Plateforme fictive de mise en relation entre freelances tech et entreprises africaines.
Projet individuel — Semestre 2 · Groupe ISI · Par Daba Fofana  Classe l1rt
...
- Bootstrap 5     (Grille, navbar, carousel, accordion, modal, cards)
-Bootstrap Icons  toutes les icones du site
-Google Fonts     Syne (titres) + Inter (corps de texte)
-js vanilla       (interactions, animations, scroll, formulaire)
=Git et GitHub    (versioning,commits et push, gestion de projet)
les principals fonctionnalités du site :
- Page d'accueil avec sections : Hero, Services, Portfolio, Témoignages, Contact
 chiffres clés s'incrémentent au scroll via IntersectionObserver
